import { getCompletionState } from './prepareCompletion';
...
const convertTextToHTML = (value = '') => String(value)
    .split(/\n{2,}/)
...
<li>Rotate supplies every 6–12 months</li>
                        ...
                        },
                        {
                            ...
                            description: 'A 4-minute walkthrough for organizing and storing your long-term home emergency supplies.'
                        },
                        {
                            id: '3-2-p3',
                            type: 'text',
...
<li>Check Aftershock regularly for updates, safety tips, and new recommendations</li>
...
export const getModuleById = (moduleId) => {
    ...
    if (!m) console.warn('prepareModules: getModuleById -> not found', moduleId);
    return m;
};
