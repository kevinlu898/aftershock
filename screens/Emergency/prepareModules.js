...
Remember: Even small earthquakes can be warning signs for larger ones. Always be prepared!`,
          ...
          checklistItems: [
            {
              id: 1,
              text: "Understand plate tectonics basics",
              completed: false,
            },
            {
              id: 2,
              text: "Learn about fault lines in your area",
              completed: false,
            },
            {
              id: 3,
              text: "Know the difference between magnitude and intensity",
              completed: false,
            },
          ],
          quizQuestions: [
...
Check your area's seismic hazard maps and know if you're in a liquefaction zone or landslide-prone area.`,
          ...
          checklistItems: [
            ...
            {
              id: 3,
              text: "Identify local emergency resources",
              completed: false,
            },
          ],
          quizQuestions: [
    ...
    lessons: [
      {
        ...
        content: {
          ...
          checklistItems: [
            {
              id: 1,
              text: "Identify safe spots in each room",
              completed: true,
            },
      ...
      },
      {
        ...
        content: {
          ...
          checklistItems: [
            {
              id: 1,
              text: "Choose an out-of-state contact person",
              completed: true,
            },
            {
              id: 2,
              text: "Save emergency numbers in your phone",
              completed: true,
            },
            { id: 3, text: "Practice texting family members", completed: true },
            {
              id: 4,
              text: "Set up group chat for family updates",
              completed: true,
            },
          ],
        },
      },
      {
        ...
        content: {
          ...
          checklistItems: [
            {
              id: 1,
              text: "Conduct a family earthquake drill",
              completed: true,
            },
            {
              id: 2,
              text: "Time how long it takes to get to safe spots",
              completed: true,
            },
    ...
    lessons: [
      {
        ...
        content: {
          ...
          checklistItems: [
            {
              id: 1,
              text: "Water (1 gallon per person per day)",
              completed: true,
            },
    ...
    lessons: [
      {
        ...
        content: {
          ...
          checklistItems: [
            ...
            {
              id: 2,
              text: "Move heavy objects to lower shelves",
              completed: false,
            },
            {
              id: 3,
              text: "Check for unsecured water heater",
              completed: false,
            },
      ...
      },
      {
        ...
        content: {
          ...
          checklistItems: [
            ...
            {
              id: 4,
              text: "Practice shutting off utilities",
              completed: false,
            },
          ],
          quizQuestions: [
    ...
    lessons: [
      {
        ...
        content: {
          ...
          checklistItems: [
            ...
            {
              id: 3,
              text: "Keep receipts for major purchases",
              completed: false,
            },
            {
              id: 4,
              text: "Store documentation in cloud storage",
              completed: false,
            },
          ],
        },
      },
      {
        ...
        content: {
          ...
          checklistItems: [
            {
              id: 1,
              text: "Review homeowners/renters policy",
              completed: false,
            },
            {
              id: 2,
              text: "Check earthquake insurance coverage",
              completed: false,
            },
