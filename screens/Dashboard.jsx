...
import { colors, globalStyles, fontSizes } from '../css';
  ...
  const handleScroll = Animated.event(
    [{ nativeEvent: { contentOffset: { x: scrollX } } }],
    {
      ...
      listener: (event) => {
        ...
        const dotIndex = Math.min(Math.round(offsetX / SNAP_INTERVAL), cards.length - 1);
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <View style={styles.container}>
          ...
          <View style={styles.headerSection}>
            ...
            <View style={[styles.progressContainer, { backgroundColor: colors.white }]}>
              <View style={prepareStyles.progressHeader}>
                <Text style={prepareStyles.progressLabel}>Prepare Progress</Text>
          ...
          <View style={styles.horizontalSection}>
            ...
            <ScrollView
              ...
              contentContainerStyle={[
                ...
                { paddingHorizontal: HORIZONTAL_PADDING, backgroundColor: 'transparent' }
              ]}
            ...
            >
              {cards.map((item, idx) => (
                <View key={item.title} style={[styles.horizontalCard, { marginRight: idx === cards.length - 1 ? 0 : CARD_GAP }]}>
                  ...
                  >
                    <Text style={styles.horizontalCardButtonText}>{item.button}</Text>
                  </TouchableOpacity>
                </View>
              ))}
            </ScrollView>
